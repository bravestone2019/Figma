...
const Panel = () => {
  ...
  return (
    ...
    <div className="panel-wrapper">
      {!collapsed && (
        <>
          <div className="panel-container left">
            <LeftPanel collapsed={collapsed} toggleCollapsed={togglePanel} hideThePanels={hideThePanels} hidden={hidden}/>
          </div>
        ...
        />
          ...
          <div className="panel-container right"> 
            ...
            {/* scale={scale} position={position} setPosition={setPosition} */}
          </div>
        </>
      )}
      </div>
      ...
      {/* {hidden && (
        <LeftPanel collapsed={collapsed} toggleCollapsed={togglePanel} hideThePanels={hideThePanels} hidden={hidden}/>  hidden={hidden}
      )} */}
    </>
  );
};
